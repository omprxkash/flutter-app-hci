  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return AppScaffold(
      ...
      body: Consumer(builder: (BuildContext context, WidgetRef ref, _) {
        final AsyncValue<List<Quiz>> async = ref.watch(quizzesForDoctorProvider(doctorId));
        return async.when(
          ...
          data: (List<Quiz> quizzes) {
            if (quizzes.isEmpty) {
              return const EmptyState(
                ...
                title: 'No quizzes',
                subtitle: 'Create a custom quiz or assign one from the preset library.',
              );
            }
                ...
                return Card(
                  child: ListTile(
                    leading: CircleAvatar(
                      ...
                      child: Icon(
                        q.isPreset ? Icons.verified_outlined : Icons.edit_outlined,
